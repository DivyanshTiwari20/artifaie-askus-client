...
const UserPostgres = {
  ...
  async findByEmail(email, includePassword = false) {
    const fields = includePassword ? '*' : 'id, name, email, role, is_active, allowed_companies, employee_id, department, created_at, updated_at';
  ...
  async findAll() {
    const query = `SELECT id, name, email, role, is_active, allowed_companies, employee_id, department, created_at, updated_at FROM users ORDER BY created_at DESC`;
